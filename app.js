...
function getWeatherReport(city) {
    fetch(`${weatherApi.baseUrl}?q=${city}&appid=${weatherApi.key}&units=metric`)
        ...
        .catch((error) => {
            console.log(error)
            if(error){
            let cont = document.getElementById("xyz")
...
function showWeatherReport(weather) {
    ...
    if (weatherType.textContent == 'Clear') {
        ...
        document.getElementById("cloud").play();

    } else if (weatherType.textContent == 'Haze') {
        console.log("prince")

        document.body.style.backgroundImage = "url('images/haze.gif')";
        document.getElementById("haze").play();
        ...
        document.getElementById("snow").play();
        ...
        document.getElementById("mist").play();
